                    ...
                    <div class="col-md-8">
                        <form action="{{ route('leads.store') }}" method="POST" class="form-horizontal"
                            ...
                            <div class="card-body">
                                ...
                                <!--<div id="realtor" class="form-group row" style="display: none">-->
                                <!--    <label for="inputEmail3" class="col-sm-2 col-form-label">Realtor</label>-->
                                <!--    <div class="col-sm-6">-->
                                <!--        <select class="form-control" name="agent_id">-->
                                <!--            <option disabled selected value="">Select ID</option>-->

                                <!--            @foreach ($agents as $agent)-->
                                <!--                <option value="{{$agent->id}}">{{optional($agent->user)->name}} - {{optional($agent->agency)->name}}</option>-->
                                <!--            @endforeach-->
                                <!--        </select>-->
                                <!--    </div>-->
                                <!--</div>-->
