        ...
        <div class="row mb-2">
            ...
            <div class="offset-sm-4 col-sm-2">
                <h1 class="float-sm-right"><span
                    ...
                    color: white;"
                        class="badge badge-pill">{{ $responsestatus->total() }}</span></h1>
            </div>
            ...
            <div class="card searcharea">
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm">
                            <form action="{{ route('responsestatus.index') }}" style="display: flex;">
                            ...
                            <a href="{{ route('responsestatus.create') }}"><button type="button"
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            @forelse ($responsestatus as $item)
                                <tr>
                                    <td>{{ $item->id }}</td>
                                    <td>{{$item->name }}</td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('responsestatus.destroy', $item->id) }}" method="POST">
