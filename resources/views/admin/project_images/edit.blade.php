        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <div class="col-md-8">
                        <form action="{{ route('projectimages.update', $project->id) }}" method="POST"
                                        ...
                                        <tbody>
                                            @foreach ($project->images as $key => $item)
                                                <tr>
                                                    ...
                                                    <td  >
                                                        <img class="form-img"
                                                            src="https://chhatt.s3.ap-south-1.amazonaws.com/projects/{{ $item->name }}">
                                                    </td>
                                                    <td><input type="text" value="{{$item->sort_order}}"></td>
                                                    <td>
                                                        <a href="{{ route('projectimages.delete', $item->id) }}"
