        ...
        <div class="row mb-2">
            ...
            <div class="offset-sm-4 col-sm-2">
                <h1 class="float-sm-right"><span
                    ...
                    color: white;"
                        class="badge badge-pill">{{ $leadsources->total() }}</span></h1>
            </div>
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm">
                            <form action="{{ route('leadsources.index') }}" style="display: flex;">
                            ...
                            <a href="{{ route('leadsources.create') }}"><button type="button"
                            ...
                            @forelse ($leadsources as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('leadsources.destroy', $item->id) }}" method="POST">
