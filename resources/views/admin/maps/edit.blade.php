        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <!-- form start -->
                    <div class="col-md-8">
                        <form action="{{ route('maps.update', $maps->id) }}" method="POST" class="form-horizontal"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input required type="text" class="form-control" value="{{ $maps->name }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select required class="form-control" name="city_id" id="city_id">
                                            ...
                                            <option  @if($item->id==$maps->city->id) selected @endif value="{{$item->id}}">{{$item->name}}</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select required class="form-control" name="area_one_id" id="area_one_id">
                                            ...
                                            <option @if ($item->id == $maps->area_one_id) selected @endif value="{{ $item->id }}">{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" name="area_two_id" id="area_two_id">
                                            ...
                                            <option @if ($item->id == $maps->area_two_id) selected @endif value="{{ $item->id }}">{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <img id="blah" class="form-img"  src="{{$maps->image}}" />
                                    </div>
                                </div>
