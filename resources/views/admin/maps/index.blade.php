                ...
                <div class="offset-sm-4  col-sm-2">
                    @if (auth()->user()->role->name == 'Administrator')
                        ...
                        <h1 class="float-sm-right"><span
                                ...
                                class="badge badge-pill">{{ $maps->total() }}</span></h1>
                </div>
                @endif
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm">
                            <form action="{{ route('maps.index') }}" style="display: flex;">
                            ...
                            @if (auth()->user()->role->name == 'Administrator')
                                <a href="{{ route('maps.create') }}"><button type="button"
                        ...
                        <tbody>
                            @forelse ($maps as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{-- <a style="padding-right:10%" href="{{ route('maps.show', $item->id) }}"
                                            class="float-left"><i class="fas fa-eye"></i></a> --}}
                                        <a style="padding-left: 20%;" href="{{ route('maps.edit', $item->id) }}"
                                            class="float-left"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('maps.destroy', $item->id) }}" method="POST">
