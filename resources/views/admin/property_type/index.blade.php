        ...
        <div class="row mb-2">
            ...
            <div class="offset-sm-4 col-sm-2">
                <h1 class="float-sm-right"><span
                    ...
                    color: white;"
                        class="badge badge-pill">{{ $propertytypes->total() }}</span></h1>
            </div>
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm">
                            <form action="{{ route('propertytypes.index') }}" style="display: flex;">
                            ...
                            <a href="{{ route('propertytypes.create') }}"><button type="button"
                        ...
                        <tbody>
                            @forelse ($propertytypes as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td>
                                        <form action="{{ route('propertytypes.destroy', $item->id) }}" method="POST">
